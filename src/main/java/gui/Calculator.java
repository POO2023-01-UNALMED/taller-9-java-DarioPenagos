...
public class Calculator extends VBox implements EventHandler<ActionEvent> {
	...
	public void handle(ActionEvent event) {
		...
		if(value.equals("/") || value.equals("*") || value.equals("-") || value.equals("+")) {
			...
			if(op.equals("+")) {
				displayText.setText(String.valueOf((intA+intB)));
			} else if(op.equals("-")) {
				displayText.setText(String.valueOf((intA-intB)));
			}else if(op.equals("*")) {
				displayText.setText(String.valueOf((intA*intB)));
			}else if(op.equals("/")) {
				displayText.setText(String.valueOf((intA*1.0/intB)));
			}
			...
			if(!ingOp) {
				intA = intA*10 + Integer.valueOf(value);
			} else {
				intB = intB*10 + Integer.valueOf(value);
			}
		}
